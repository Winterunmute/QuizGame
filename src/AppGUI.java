...
// // Huvudpanelen som använder CardLayout för att kunna ändra från startskärm
// till spelskärm i samma utrymme
...
// // Kategorival panelen med 4 olika knappar som representerar de 4 olika
// kategorierna
...
// //
// // // En for loop för att lägga till 4 stycken knappar med val från 2 till 5
// rundor
// // for (int i = 2; i <= 5; i++) {
...
// // Lägger till dessa för att kunna hantera ändringen av färg vid fel / rätt
// svar
...
// gameSession.setChosenCategory("Historia"));
// geographyButton.addActionListener(e ->
// gameSession.setChosenCategory("Geografi"));
// sportsButton.addActionListener(e -> gameSession.setChosenCategory("Sport"));
// chemistryButton.addActionListener(e ->
// gameSession.setChosenCategory("Kemi"));
...
// // Markera knapparna
// if (isCorrect) {
// // Om användaren klickar på knappen med rätt svar: sätt bakgrunden på den
// klickade knappen till grön
// answerButtons[answerIndex - 1].setBackground(Color.GREEN);
// } else {

// // Om användaren klickar en knapp med fel svar: sätt bakgrunden röd på den
// klickade knappen
...
// StringBuilder resultsMessage = new StringBuilder("<html><h1>Spelet är slut!
// Slutresultat:</h1><ul>");
...
// JOptionPane.showMessageDialog(this, resultsMessage.toString(),
// "Slutresultat", JOptionPane.INFORMATION_MESSAGE);
